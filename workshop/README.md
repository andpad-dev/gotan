...
- [Discord](https://discord.gg/hDWW4NATAd): 当日の連絡と、参加者どうしのやりとりに使う

Discord は最初に開いておいてください。班のなかで Playground の URL を渡し合ったり、詰まったところを書き込んだりする場として使います。
発表のときも、まとめを書いた Issue の URL をここに貼ってもらいます。PC を投影に繋ぎ替えずに済ませるためです。
ワークショップが終わったあとも残るので、後日の質問もこちらへどうぞ。
...
発表用まとめを書いた Issue の URL を Discord に貼ってください。ファシリテーターの画面で開くので、PC を投影に繋ぎ替える必要はありません。
映った画面を見ながら、次の3点を話してください。
