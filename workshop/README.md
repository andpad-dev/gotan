...
Discord は最初に開いておいてください。運営からの連絡はここに流します。
班のなかで Playground の URL を渡し合ったり、詰まったところを書き込んだりする場としても使って構いません。
...
調べた過程をブログに書くのもおすすめです。「どう調べたか」は、結論そのものより読まれます。書いたら Discord で教えてください。
